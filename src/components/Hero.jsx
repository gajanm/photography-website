...
const Hero = () => {
  ...
  return (
    <div className='md:flex overflow-hidden text-white '>
      <div className='w-1/2 h-screen flex flex-col justify-center items-center'>
        <h1 className="text-xl font-bold p-2 mb-1"> Hi, I am Naresh </h1>
        <h3 className='md:text-3xl sm:text-2xl text-lg items-center text-center font-bold flex w-[75%] h-[25%] py-[100px]'>A New Jersey-based high schooler with a passion for photography and a desire to become a commercial photographer.</h3>
